...

{
  ...
  render_highquality(filename = img_name, interactive = FALSE, lightdirection = 280, lightaltitude = c(20, 80), lightcolor = c(color1[2], "white"), lightintensity = c(600, 100), samples = 450, width = 6000, height = 6000)
  end_time <- Sys.time()
